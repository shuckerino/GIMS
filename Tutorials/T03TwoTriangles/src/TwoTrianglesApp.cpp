...
class TwoTrianglesApp : public DX12App
{
private:  
  ...
  void createPipeline()
  {
    ...
    const auto vertexShader =
        compileShader(L"../../../Tutorials/T03TwoTriangles/Shaders/TwoTriangles.hlsl", L"VS_main", L"vs_6_0");

    const auto pixelShader =
        compileShader(L"../../../Tutorials/T03TwoTriangles/Shaders/TwoTriangles.hlsl", L"PS_main", L"ps_6_0");
...
public:
  TwoTrianglesApp(const DX12AppConfig createInfo)
      : DX12App(createInfo)
  {
    createRootSignature();
    createPipeline();
...
int main(int /* argc*/, char /* **argv */)
{
  ...
  config.title    = L"Tutorial 03 Two Triangles";
  config.useVSync = true;
  try
  {
    TwoTrianglesApp app(config);
    app.run();
  }
