...
class TwoTexturesAppOneTable : public DX12App
{
private:
  ...
  void createRootSignature()
  {
    ...
    parameter.InitAsDescriptorTable(1, &range[0]);
  ...
  void createPipeline()
  {
    ...
    const auto vertexShader =
        compileShader(L"../../../Tutorials/T12TwoTexturesOneTable/Shaders/TwoTextures.hlsl", L"VS_main", L"vs_6_0");

    const auto pixelShader =
        compileShader(L"../../../Tutorials/T12TwoTexturesOneTable/Shaders/TwoTextures.hlsl", L"PS_main", L"ps_6_0");
...
public:
  TwoTexturesAppOneTable(const DX12AppConfig createInfo)
      : DX12App(createInfo)
  {
    createRootSignature();
    createPipeline();
...
int main(int /* argc*/, char /* **argv */)
{
  ...
  config.title    = L"Tutorial 12 Two Textures One Table";
  config.useVSync = true;
  try
  {
    TwoTexturesAppOneTable app(config);
    app.run();
  }
